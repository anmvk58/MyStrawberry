...
if __name__ == '__main__':
    ...
    # print(filename)
    filename = '20230219'
    df = pd.read_excel(f"C:\\Users\\anmv\\Desktop\\Dâu Tây\\2023\\{filename}.xlsx")
    # print(df)
    df_details = pd.read_excel(f"C:\\Users\\anmv\\Desktop\\Dâu Tây\\2023\\{filename}d.xlsx")
    ...
    writer = pd.ExcelWriter(f"C:\\Users\\anmv\\Desktop\\Dâu Tây\\2023\\{filename}result.xlsx", engine='xlsxwriter')
    ...
    writer.close()
    # print(final_result)
    # result.to_excel(f"C:\\Users\\anmv\\Desktop\\Dâu Tây\\2023\\{filename}result.xlsx", engine='xlsxwriter', index=False)
    print("Finished")